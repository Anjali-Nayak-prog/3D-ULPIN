            ...
            <div className="space-y-0.5">
              {group.layers.map((layer) => (
                <div
                  key={layer.id}
                  className={cn(
                    'flex items-center gap-2.5 rounded-lg px-2 py-1.5 transition-colors hover:bg-slate-100/70',
                  )}
                >
                  <input
                    type="checkbox"
                    ...
                    className="h-3.5 w-3.5 cursor-pointer appearance-none rounded border border-slate-300 bg-transparent transition-all checked:border-transparent checked:bg-primary-500"
                    style={{
                      ...(layer.visible
                  ...
                  />
                  <span className="flex-1 truncate text-xs text-slate-600">{layer.name}</span>
                  <input
                    type="range"
                    min={10}
                    max={100}
                    ...
                    className="h-1 w-16 cursor-pointer appearance-none rounded-full bg-slate-200 accent-primary-400"

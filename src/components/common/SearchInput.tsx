    ...
    return (
      <div className={cn('relative', className)}>
        ...
        <input
          ...
          type="text"
          className={cn(
            'h-9 w-full rounded-lg border border-slate-200 bg-navy-900/80 pl-10 pr-4 text-sm text-slate-700 placeholder-slate-500 outline-none transition-all focus:border-primary-400/50 focus:bg-navy-800',
          )}
